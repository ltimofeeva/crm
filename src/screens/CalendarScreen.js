...
const styles = StyleSheet.create({
  ...
  blockBox: {
    position: "absolute", left: 3, right: 3, borderRadius: 8, padding: 4,
    backgroundColor: C.line, overflow: "hidden", justifyContent: "center",
  },
  blockBoxT: { fontSize: 10, color: C.inkSoft, fontWeight: "600" },
  blockBoxTime: { fontSize: 9, color: C.inkSoft, marginTop: 1 },
  modalBackdrop: { flex: 1, backgroundColor: "rgba(22,27,25,0.4)", alignItems: "center", justifyContent: "center", padding: 16 },
  ...
  sugBox: {
    ...
    overflow: "hidden",
    shadowColor: C.ink, shadowOpacity: 0.12, shadowRadius: 10, shadowOffset: { width: 0, height: 4 },
  },
